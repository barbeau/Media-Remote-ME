...
import MediaRemoteME.iTunesServer.webservlet6.JavonGateways;
import MediaRemoteME.iTunesServer.webservlet6.InvocationAbstraction;
import MediaRemoteME.iTunesServer.webservlet6.Utility;
 ...
 * </ul>
 */
public class WebToMobileServlet2 extends HttpServlet {
    ...
    static {
        METHODS = new HashMap();
        METHODS.put( new Integer(1), new JavonGateways.MediaRemoteME_iTunesServer_webservlet6_SubmitCommandSubmitCommand1Gateway());
    }
